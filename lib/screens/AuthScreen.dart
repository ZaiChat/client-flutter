...
class AuthState extends State<AuthScreen> {
  ...
  void startLoginFlow() {
    _loginState = _LoginState.emailAddress;
    notifyListeners();
  }
  ...
  Future<void> verifyEmail(
    ...
    try {
      ...
      if (methods.contains('password')) {
        _loginState = _LoginState.password;
      } else {
        _loginState = _LoginState.register;
      }
      _email = email;
      notifyListeners();
  ...
  Widget build(BuildContext context) {
    switch (_loginState) {
      case _LoginState.loggedOut:
        return EmailForm(
            callback: (email) => verifyEmail(email, (e) { })
        );
      case _LoginState.password:
        return PasswordForm(
          email: email!,
